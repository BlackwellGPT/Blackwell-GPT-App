    ...
    return (
        <View style={styles.shadow} className="sticky top-0 z-50 flex h-14 w-full shrink-0 items-center justify-center border-b border-gray-300 px-1">
            <View className="flex w-full px-2 flex-row">
                <Text style = {styles.textStyle}>Blackwell</Text>
                ...
                <TouchableOpacity style = {styles.coolStyle} onPress={() => navigation.navigate('Past Conversations')}>
                    <Svg width={32} height={32} fill="green" viewBox='0 0 256 256' className="opacity-80">
                ...
                <TouchableOpacity style = {styles.coolStyle} onPress={() => navigation.navigate('Usage Guide')}>
                    <Svg width={32} height ={32} fill="green" viewBox='0 0 256 256' className="opacity-80">
