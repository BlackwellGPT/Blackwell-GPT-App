    ...
    <View style = {{backgroundColor:'white'}}>
      <FlatList 
            ...
            renderItem={() => {
              return (
                <View>
                  <Text style = {{fontSize: 30, alignSelf: 'center', padding: 30, paddingBottom: 0, fontWeight: 'bold', color: "black"}}>How to use</Text>
                  ...
                  <Text style = {{fontSize: 30, alignSelf: 'center', padding: 35, paddingBottom: 5, paddingTop: 20, color: "black", fontWeight: 'bold'}}>FAQS</Text>
