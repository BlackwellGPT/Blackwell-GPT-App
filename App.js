  ...
  return (
    <Drawer.Navigator drawerContent = {props => <CustomDrawer {...props}/>}screenOptions={{headerShown:true, drawerLabelStyle:{marginLeft: -20}, drawerActiveBackgroundColor: "#ADD8E6", drawerActiveTintColor: "#5494DA"}}>
      <Drawer.Screen name="Home" component={HomeScreen} options={{
        drawerIcon: () => {
          return (
            <Svg fill="#bbbbbb" viewBox='0 0 256 256' className='w-6 h-6' width='20' height ="20">
      ...
      <Drawer.Screen name='Settings' component = {Settings} options= {{
        drawerIcon: () => {
          return (
            <Svg fill ="#bbbbbb" color="#000" weight="duotone" viewBox='0 0 256 256' className='w-6 h-6' width='20' height ="20">
