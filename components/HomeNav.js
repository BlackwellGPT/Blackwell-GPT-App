...
export default function HomeNav ({ navigation }) {
  return (
    <View
      style={styles.shadow}
      className='sticky top-0 z-50 flex h-14 w-full shrink-0 items-center justify-center border-b border-gray-300 px-1'
    >
      <View className='flex w-full px-2 flex-row'>
        <Text style={styles.textStyle}>Blackwell</Text>
        <Text style={styles.textStyleone}>GPT</Text>
